            ...
            <aside className='basis-4/12 p-6 border border-1 border-[#e0e0e0] h-full'>
                ...
                <div className='flex flex-col gap-2 text-[#4F4F4F] mb-6'>
                    <p className='text-base flex justify-between'>
                        Sub-total 
                        <span className='text-[#333]'>130$</span>
                    </p>
                    <p className='text-base flex justify-between'>
                        Shipping 
                    ...
                    <p className='text-base flex justify-between'>
                        Tax 
                        <span className='text-[#333]'>54.76%</span>
                    </p>
                    <Divider className='m-0'/>
                    <p className='text-base flex justify-between font-lg text-[#333]'>Total <span className='font-bold'>432.65$</span></p>
                </div>
